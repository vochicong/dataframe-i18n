...
md"Lấy ví dụ đơn giản, 
giả sử chúng ta có một bảng dữ liệu cá nhân chỉ có hai cột là tên và tuổi.
Tuy nhiên dữ liệu này có tên cột là tiếng Nhật, 
và các tên cột thỉnh thoảng có thay đổi nhỏ khi được khách hàng cung cấp.
Làm thế nào để các thành viên không biết tiếng Nhật vẫn có thể làm việc hiệu quả trên dữ liệu này, dối phó một cách linh động với sự thay đổi tên cột trong tiếng Nhật, và cuối cùng có thể đưa ra kết quả công việc với tên cột là tiếng Nhật?
"

# ╔═╡ 75c185d1-c284-4443-b6bf-551079ce1a27
df_in = DataFrame(
	フルネーム=["孫 悟空", "猪 八戒", "沙 悟浄", "玄奘 三蔵"],
	歳=[22, 19, 18, 30]
)
